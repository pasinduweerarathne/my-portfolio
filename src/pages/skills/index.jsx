...
const technical_skills = [
  ...
  { type: "CSS", perc: "group-hover:w-[10%] w-0", icon: css },
  { type: "Javascript", perc: "group-hover:w-[30%] w-0", icon: js },
  { type: "Typescript", perc: "group-hover:w-[50%] w-0", icon: ts },
  { type: "React.js", perc: "group-hover:w-[90%] w-0", icon: reactjs },
  { type: "Node.js", perc: "group-hover:w-[10%] w-0", icon: nodejs },
  { type: "PHP", perc: "group-hover:w-[80%] w-0", icon: php },
  { type: "RESTful API", perc: "group-hover:w-[89%] w-0", icon: restApi },
  { type: "MySQL", perc: "group-hover:w-[90%] w-0", icon: mySql },
  { type: "PostgreSQL", perc: "group-hover:w-[90%] w-0", icon: postgresql },
  { type: "MongoDB", perc: "group-hover:w-[50%] w-0", icon: mongodb },
  { type: "Firebase", perc: "group-hover:w-[10%] w-0", icon: firebase },
  { type: "Express.js", perc: "group-hover:w-[10%] w-0", icon: expressjs },
  { type: "GitHub", perc: "group-hover:w-[10%] w-0", icon: github },
  { type: "Bitbucket", perc: "group-hover:w-[10%] w-0", icon: bitbucket },
];

const soft_skills = [
  {
    type: "Communication",
    perc: "group-hover:w-[50%] w-0",
    icon: conversation,
  },
  {
...
const Skills = () => {
  return (
    <>
      ...
      <div className="max-w-3xl mt-20 mx-auto flex flex-col gap-20">
        <div>
